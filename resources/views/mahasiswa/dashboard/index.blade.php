...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path={{ asset('user-assets') }} data-template="vertical-menu-template-free">
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('user-assets/vendor/css/theme-default.css') }}"
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            <!-- Menu / sidemenu -->
            @include('mahasiswa.layout.sidemenu')
            <!-- /Menu -->
                                    ...
                                    <div class="d-flex align-items-end row">
                                        ...
                                        <div class="col-sm-5 text-center text-sm-left">
                                            <div class="card-body pb-0 px-0 px-md-4">
                                                <img src="{{ asset('') }}user-assets/img/illustrations/man-with-laptop-light.png"
                                            ...
                                            <div class="card-body">
                                                <div
                                                    ...
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="{{ asset('') }}user-assets/img/icons/unicons/chart-success.png"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div
                                                    class="card-title d-flex align-items-start justify-content-between">
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="{{ asset('') }}user-assets/img/icons/unicons/wallet-info.png"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div
                                                    class="card-title d-flex align-items-start justify-content-between">
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="{{ asset('') }}user-assets/img/icons/unicons/paypal.png"
                                                            alt="Credit Card" class="rounded" />
                                                    </div>
                                                    <div class="dropdown">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div
                                                    class="card-title d-flex align-items-start justify-content-between">
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="{{ asset('') }}user-assets/img/icons/unicons/cc-primary.png"
                                                            alt="Credit Card" class="rounded" />
                                                    </div>
                                                    <div class="dropdown">
                                        ...
                                        <div class="tab-content p-0">
                                            <div class="tab-pane fade show active" id="navs-tabs-line-card-income"
                                                ...
                                                <div class="d-flex p-4 pt-3">
                                                    <div class="avatar flex-shrink-0 me-3">
                                                        <img src="{{ asset('user-assets/img/icons/unicons/wallet.png') }}"
                                                            alt="User" />
                                                    </div>
                                                    <div>
